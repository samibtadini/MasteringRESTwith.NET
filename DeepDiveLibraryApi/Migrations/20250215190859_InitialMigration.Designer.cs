...
namespace DeepDiveLibraryApi.Migrations
{
    ...
    [Migration("20250215190859_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeepDiveLibraryApi.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeepDiveLibraryApi.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeepDiveLibraryApi.Entities.Course", b =>
                {
                    b.HasOne("DeepDiveLibraryApi.Entities.Author", "Author")
                        .WithMany("Courses")
